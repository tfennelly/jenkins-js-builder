...
describe("require-stub-transform", function () {
    ...
    it("- test no mappings", function (done) {
        buildBrowserPack('module1.js', function (packEntries) {
            var metadata = transformModule.updateBundleStubs(packEntries, {ignoreMissing: true, moduleMappings: []});
    ...
    it("- test one mapping - no dependencies", function (done) {
        buildBrowserPack('module1.js', function (packEntries) {
            ...
            var metadata = transformModule.updateBundleStubs(packEntries, {ignoreMissing: true, moduleMappings: [{from: './module6', to: 'mod6:mod6v2'}]});
            ...
            expect(module6PackEntry.source).toBe("module.exports = require('____jenkins_doImport').doImport('mod6:mod6v2');");
            // Should only depend on js-modules ...
            expect(countDependencies(module6PackEntry)).toBe(1);
            expect(module6PackEntry.deps['____jenkins_doImport']).toBeDefined();
    ...
    it("- test one mapping - has unshared dependencies", function (done) {
        buildBrowserPack('module1.js', function (packEntries) {
            ...
            // See the dependency graph illustration in module1.js
            var metadata = transformModule.updateBundleStubs(packEntries, {ignoreMissing: true, moduleMappings: [{from: './module7', to: 'mod7:mod6v2'}]});
    ...
    it("- test one mapping - has shared dependencies", function (done) {
        buildBrowserPack('module1.js', function (packEntries) {
            ...
            // the bundle.
            // See the dependency graph illustration in module1.js
            var metadata = transformModule.updateBundleStubs(packEntries, {ignoreMissing: true, moduleMappings: [{from: './module2', to: 'mod2:mod6v2'}]});
